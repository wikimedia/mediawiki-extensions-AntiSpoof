...
$messages['ba'] = array(
	...
	'antispoof-conflict-top' => '"$1" исеме булған {{PLURAL:$2|файҙаланыусы исеменә}} бигерәк оҡшаш:', # Fuzzy
...
$messages['be-tarask'] = array(
	...
	'antispoof-conflict-top' => 'Імя «$1» занадта падобнае на {{PLURAL:$2|1=наступны рахунак|наступныя рахункі}}:', # Fuzzy
	'antispoof-conflict-bottom' => 'Калі ласка, выберыце іншую назву рахунку.',
